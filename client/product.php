...
foreach ($brands as $brand) {
 ...
 ?>
  <button class="btn" data-filter=".<?php echo $brand['brand'];?>"><?php echo $brand['brand'];?></button>
 <?php
}
...
foreach($phones as $phone){
  ?>
    <div class="grid-item border <?php echo $phone['brand'];?>" >
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  <div class="item py-2" style="width: 200px;">
                    <div class="product font-rale">
                      <div class="d-flex flex-column">
                        <a href="#"><img src="/summerproject/admin/uploads/<?php echo $phone['image'];?>" class="img-fluid" alt="pro1"
